...
lr = 0.9          #learning rate, how fast the Q-learning will learn at
y = 0.95       #discount factor, how much future rewards matter
num_episodes = 2000
...
avgList = []
count = 0
for i, val in enumerate(rewardsList):
    count += val
    avgList.append(count/(i+1))
plt.plot(avgList)
plt.ylabel('Average Reward on Nth Iteration')
plt.show()
